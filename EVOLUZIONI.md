...
Stato: note di progettazione, non autorizzazione all'implementazione. Il prodotto aiuta gli astrofotografi a pianificare sessioni; semplicità e correttezza dei dati precedono l'aggiunta di funzioni.
...
## Punti da chiarire prima dell'implementazione

- Crepuscoli: l'alfa applica già Sole <= -18 gradi, ma non espone una tabella separata degli eventi. Proposta minima: mostrare inizio e fine della notte astronomica; soglie civile (-6) e nautica (-12) restano informazioni eventualmente aggiungibili, non nuovi criteri approvati. Gestire eventi assenti nel periodo analizzato.
- Copertura: i sei cataloghi DSO non sostituiscono il catalogo stellare di SkyChart. Arturo e molte altre stelle diventerebbero indisponibili senza una fonte stellare aggiuntiva. Decidere se accettare un perimetro DSO o mantenere anche le stelle.
...
- Fuso: oggi Europe/Rome è fisso. Per postazioni fuori da quel fuso serve selezione esplicita del fuso della postazione; non assumere che coincida con quello del computer.
